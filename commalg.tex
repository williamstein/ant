...
\begin{remark}
	...
	of isogenies, see \cite[\S11.2]{Koblitz2011781}
	for an example.
\end{remark}
...
\begin{exercise}
	...
	given number field.
	\begin{enumerate}
	\item The ring $R = \ZZ[i]$ in the number field $\Q(i)$.
	\item The ring $R = \ZZ[i/2]$ in the number field $\Q(i)$.
	\item The ring $R = \ZZ[17i]$ in the number field $\Q(i)$.
	\item The ring $R = \ZZ[i]$ in the number field $\Q(\sqrt[4]{-1})$.
	\end{enumerate}
\end{exercise}
