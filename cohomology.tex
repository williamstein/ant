...
(recall that Galois means is normal and separable),
...
\begin{exercise}
	...
	if and only if for every $a\in A$ the subgroup
	$$
...
%TODO show this limit agrees with check cohomology and cite result
%TODO in Milne LEC?
